...
export const FrequencyTuner: React.FC<FrequencyTunerProps> = ({ targetFreq, onSuccess, onCancel }) => {
  ...
  return (
    <div className="absolute inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md">
      <div className="relative w-80 rounded-xl border border-[#00E6FF] bg-[#0A0A0F] p-6 shadow-[0_0_50px_rgba(0,230,255,0.2)]">
...
const Waveform = ({ frequency, color, speed }: { frequency: number, color: string, speed: number }) => {
   ...
   return <canvas ref={canvasRef} width={280} height={128} className="absolute inset-0" />;
};
