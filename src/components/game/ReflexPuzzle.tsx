...
export const ReflexPuzzle: React.FC<ReflexPuzzleProps> = ({ onComplete }) => {
  ...
  return (
    <div className="flex flex-col items-center gap-6 w-full max-w-md">
      <div className="flex justify-between w-full font-mono text-sm text-[#00E6FF]">
      ...
      <div className="relative h-[400px] w-full overflow-hidden rounded-xl border border-white/10 bg-black/50">
         ...
         {packets.map(p => (
            ...
            >
               <div 
                 className={`flex h-12 w-12 items-center justify-center rounded-lg border-2 shadow-[0_0_15px_currentColor] transition-transform ${
                   p.type === 'VIRUS' 
